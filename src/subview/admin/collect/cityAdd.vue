<template>
  <div class="page">
    <el-form ref="form" :rules="rules"  :model="form" label-width="120px">
        <el-form-item label="所属省份" ><!-- :label="group.label" -->
      ...
      <el-form-item label="市级名称" prop="cityName">
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('form')">添加市级</el-button>
...
export default {
  ...
  created() {
      this.GLOBAL.getLocation((data)=>{
              ...
              this.form.location.option = data.provCategorys
  ...
  methods:{
      submitForm(formName) {
            let data;
            this.$http.post(this.$api.City_insert, this.Qs.stringify({
              "cityCategoryJ.cityName": this.form.cityName,
              "cityCategoryJ.provCategoryId": this.form.location.keyword
            }))
            .then((response) => {
