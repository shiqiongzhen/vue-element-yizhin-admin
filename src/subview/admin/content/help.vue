    ...
    <div class="search_container">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-form-item style="float: right;">
          <router-link to="/main/help/add"><el-button type="primary" icon="el-icon-plus"></el-button></router-link>
        </el-form-item>
      </el-form>
    </div>
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      ...
      handleEdit(index, row) {
        ...
        this.$router.push('/main/help/edit/'+ row.articleId)
      },
